...
Installation for the backend api 

To run this server clone in a separate folder with : git clone https://github.com/udacity/reactnd-project-readable-starter.git Install packages: npm install

Launch server: node server Unless modified in config.js server will use port 5001

Getting up React Redux Readable project
 store the zip files and install all the packages run : npm install
